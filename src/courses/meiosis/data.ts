...
const spermStages: Stage<MeiosisState>[] = [
    st("spermatogonium", "精原细胞（间期前）",
      ...
      { chromosome: 4, dna: 4, chromatid: 0, dnaPerChromosome: 1 }, undefined, "精原细胞"),
    st("interphase", "间期（复制）",
    ...
    st("prophase-I", "减Ⅰ前期",
      ...
      { chromosome: 4, dna: 8, chromatid: 8, dnaPerChromosome: 2 }),
    st("metaphase-I", "减Ⅰ中期",
      ["同源染色体成对排列在赤道面", "注意：是「成对排列」，不同于有丝分裂的「逐条排列」"],
...
const ooStages: Stage<MeiosisState>[] = [
    st("oo-oogonium", "卵原细胞（间期前）",
      ...
      { cells: 1, replicated: false, pairing: false, crossingOver: false, equatorial: "none", separating: "none", spermShape: false },
      { chromosome: 4, dna: 4, chromatid: 0, dnaPerChromosome: 1 }, undefined, "卵原细胞"),
    ...
    st("oo-anaphase-I", "减Ⅰ后期（不均等分裂）",
      ...
      { chromosome: 4, dna: 8, chromatid: 8, dnaPerChromosome: 2 }, undefined, "减Ⅰ后期"),
    ...
    st("oo-metaphase-II", "减Ⅱ中期（停滞待受精）",
      ...
      { chromosome: 2, dna: 4, chromatid: 4, dnaPerChromosome: 2 }, undefined, "减Ⅱ中期"),
